...
rtm.on('error', log.error);
rtm.on('connected', log.error);
rtm.on('connecting', log.error);
rtm.on('disconnected', log.error);
rtm.on('disconnecting', log.error);
rtm.on('reconnecting', log.error);
